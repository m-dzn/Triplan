var product = {
    ...
    fetchProductList: function() {
        $.ajax({
            ...
            dataType: 'json',
            success: (pagination) => {
                console.log('fetchProductList', pagination);
                ...
                pageBtnList.push($(
                    `<li class="page-item ${pagination.hasPrev ? "" : "disabled"}">` +
                        `<a class="page-link" href="${BASE_URL}/product?pageSize=${this.pageSize}&currentPage=${pagination.startPage - 1}" aria-label="Previous">` +
                ...
                for (var i = pagination.startPage; i <= pagination.endPage; i++) {
                    pageBtnList.push($(
                        `<li class="page-item">` +
                            `<a class="page-link" href="${BASE_URL}/product?pageSize=${this.pageSize}&currentPage=${i}">${i}</a>` +
                        `</li>`
                    ).get(0));
                }
                ...
                pageBtnList.push($(
                    `<li class="page-item ${pagination.hasNext ? "" : "disabled"}">` +
                        `<a class="page-link" href="${BASE_URL}/product?pageSize=${this.pageSize}&currentPage=${pagination.endPage + 1}" aria-label="Next">` +
